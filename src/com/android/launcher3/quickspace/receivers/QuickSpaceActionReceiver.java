...
public class QuickSpaceActionReceiver {
    ...
    private void openGoogleCalendar(View view) {
        ...
        try {
            ...
            LauncherAppsCompat.getInstance(mContext).showAppDetailsForProfile(new ComponentName(Utilities.SEARCH_PACKAGE, ""), Process.myUserHandle(), null, null);
        }
    }
    ...
    private void openGoogleWeather(View view) {
        ...
        intent.setComponent(new ComponentName(Utilities.SEARCH_PACKAGE, "com.google.android.apps.gsa.velour.DynamicActivityTrampoline"));
        try {
            Launcher.getLauncher(mContext).startActivitySafely(view, intent, null, null);
        } catch (ActivityNotFoundException ex) {
            LauncherAppsCompat.getInstance(mContext).showAppDetailsForProfile(new ComponentName(Utilities.SEARCH_PACKAGE,
