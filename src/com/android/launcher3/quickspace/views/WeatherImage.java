...
public class WeatherImage extends ImageView implements
        OmniJawsClient.OmniJawsObserver {

    private String TAG = WeatherImage.class.getSimpleName();
    ...
    public WeatherImage(Context context, AttributeSet attrs, int defStyle) {
