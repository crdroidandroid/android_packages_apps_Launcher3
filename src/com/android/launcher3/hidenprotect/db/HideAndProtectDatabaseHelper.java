 ...
 */
package com.android.launcher3.hidenprotect.db;
...
public class HideAndProtectDatabaseHelper extends SQLiteOpenHelper {
    ...
    @Nullable
    private static HideAndProtectDatabaseHelper sSingleton;

    private HideAndProtectDatabaseHelper(@NonNull Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    public static synchronized HideAndProtectDatabaseHelper getInstance(@NonNull Context context) {
        if (sSingleton == null) {
            sSingleton = new HideAndProtectDatabaseHelper(context);
        }
